...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => '<img src="https://s.nmxc.ltd/sakurairo_vision/@3.0/series/login_logo.webp" style="width:50px;height:50px;transform:translateY(32%);margin-right: 13px;">Shinonomeiro 主题设置 <small> / Shinonomeiro Options / Shinonomeiro 設定</small>',
      'framework_class'         => '',
      ...
      // footer
      'footer_text'             => 'Shinonomeiro 使用 Fuukei 定制的 <a href="https://github.com/Fuukei/Shinonomeiro_CSF" target="_blank">CSF</a> 设置框架，感谢你的使用 0v0',
      'footer_after'            => '',
      'footer_credit'           => '',
            ...
            foreach ( $this->pre_sections as $section ) {
              ...
              if ( ! empty( $section['fields'] ) ) {
                ...
                foreach ( $section['fields'] as $field ) {
                  ...
                  Shinonomeiro_CSF::field( $field, $value, $this->unique, 'options' );
