...
if ( ! function_exists( 'iro_customizer_legacy_description_from_key' ) ) {
	function iro_customizer_legacy_description_from_key( $legacy_key ) {
		$description_map = [
			...
			'aplayer_server' => esc_html__( '配置 APlayer 播放器的server参数。', 'Shinonomeiro_C' ),
			'custom_music_api' => esc_html__( '设置custom music api相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'aplayer_server_proxy' => esc_html__( '配置 APlayer 播放器的server_proxy参数。', 'Shinonomeiro_C' ),
			'aplayer_playlistid' => esc_html__( '配置 APlayer 播放器的playlistid参数。', 'Shinonomeiro_C' ),
			'aplayer_order' => esc_html__( '配置 APlayer 播放器的order参数。', 'Shinonomeiro_C' ),
			'aplayer_preload' => esc_html__( '配置 APlayer 播放器的preload参数。', 'Shinonomeiro_C' ),
			'aplayer_volume' => esc_html__( '配置 APlayer 播放器的volume参数。', 'Shinonomeiro_C' ),
			'aplayer_cookie' => esc_html__( '配置 APlayer 播放器的cookie参数。', 'Shinonomeiro_C' ),
			...
			'social_area' => esc_html__( '设置social area相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'social_display_icon' => esc_html__( '设置social display icon相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'social_area_radius' => esc_html__( '设置social area radius相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'wechat_qrcode_switch' => esc_html__( '设置社交卡片中微信相关信息（qrcode_switch）。', 'Shinonomeiro_C' ),
			'wechat_qrcode' => esc_html__( '设置社交卡片中微信相关信息（qrcode）。', 'Shinonomeiro_C' ),
			'wechat_id' => esc_html__( '设置社交卡片中微信相关信息（id）。', 'Shinonomeiro_C' ),
			'wechat_copy_switch' => esc_html__( '设置社交卡片中微信相关信息（copy_switch）。', 'Shinonomeiro_C' ),
			'wechat_url' => esc_html__( '设置社交卡片中微信相关信息（url）。', 'Shinonomeiro_C' ),
			'qq_qrcode_switch' => esc_html__( '设置社交卡片中 QQ 相关信息（qrcode_switch）。', 'Shinonomeiro_C' ),
			'qq_qrcode' => esc_html__( '设置社交卡片中 QQ 相关信息（qrcode）。', 'Shinonomeiro_C' ),
			'qq_id' => esc_html__( '设置社交卡片中 QQ 相关信息（id）。', 'Shinonomeiro_C' ),
			'qq_copy_switch' => esc_html__( '设置社交卡片中 QQ 相关信息（copy_switch）。', 'Shinonomeiro_C' ),
			'qq_url' => esc_html__( '设置社交卡片中 QQ 相关信息（url）。', 'Shinonomeiro_C' ),
			...
			'diysocialicons' => esc_html__( '设置diysocialicons相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'exhibition' => esc_html__( '设置exhibition相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'post_cover_options' => esc_html__( '设置post cover options相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'post_cover' => esc_html__( '设置post cover相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'clipboard_ref' => esc_html__( '设置clipboard ref相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'page_lazyload' => esc_html__( '设置page lazyload相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'page_lazyload_spinner' => esc_html__( '设置page lazyload spinner相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'page_temp_title_font_size' => esc_html__( '设置page temp title font size相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'bangumi_source' => esc_html__( '配置番剧模块的bangumi source数据源与展示参数。', 'Shinonomeiro_C' ),
			'my_anime_list_username' => esc_html__( '配置番剧模块的my anime list username数据源与展示参数。', 'Shinonomeiro_C' ),
			'my_anime_list_sort' => esc_html__( '配置番剧模块的my anime list sort数据源与展示参数。', 'Shinonomeiro_C' ),
			'bilibili_id' => esc_html__( '配置番剧模块的bilibili id数据源与展示参数。', 'Shinonomeiro_C' ),
			'bilibili_cookie' => esc_html__( '配置番剧模块的bilibili cookie数据源与展示参数。', 'Shinonomeiro_C' ),
			'bangumi_id' => esc_html__( '配置番剧模块的bangumi id数据源与展示参数。', 'Shinonomeiro_C' ),
			'bangumi_cache' => esc_html__( '配置番剧模块的bangumi cache数据源与展示参数。', 'Shinonomeiro_C' ),
			'friend_link_align' => esc_html__( '设置友情链接页面的align显示规则。', 'Shinonomeiro_C' ),
			'friend_link_form' => esc_html__( '设置友情链接页面的form显示规则。', 'Shinonomeiro_C' ),
			'friend_link_sorting_mode' => esc_html__( '设置友情链接页面的sorting_mode显示规则。', 'Shinonomeiro_C' ),
			'friend_link_order' => esc_html__( '设置友情链接页面的order显示规则。', 'Shinonomeiro_C' ),
			'steam_id' => esc_html__( '配置 Steam 展示模块的id参数。', 'Shinonomeiro_C' ),
			'steam_key' => esc_html__( '配置 Steam 展示模块的key参数。', 'Shinonomeiro_C' ),
			'steam_covercdn' => esc_html__( '配置 Steam 展示模块的covercdn参数。', 'Shinonomeiro_C' ),
			'steam_store' => esc_html__( '配置 Steam 展示模块的store参数。', 'Shinonomeiro_C' ),
			'steam_cache' => esc_html__( '配置 Steam 展示模块的cache参数。', 'Shinonomeiro_C' ),
			'smilies_name' => esc_html__( '配置评论区表情包的name。', 'Shinonomeiro_C' ),
			'smilies_dir' => esc_html__( '配置评论区表情包的dir。', 'Shinonomeiro_C' ),
			'smilies_proxy' => esc_html__( '配置评论区表情包的proxy。', 'Shinonomeiro_C' ),
			'comment_useragent' => esc_html__( '设置评论系统的useragent行为。', 'Shinonomeiro_C' ),
			'comment_location' => esc_html__( '设置评论系统的location行为。', 'Shinonomeiro_C' ),
			...
			'comment_private_message' => esc_html__( '设置评论系统的private_message行为。', 'Shinonomeiro_C' ),
			'comment_captcha_select' => esc_html__( '设置评论系统的captcha_select行为。', 'Shinonomeiro_C' ),
			'qq_avatar_link' => esc_html__( '设置社交卡片中 QQ 相关信息（avatar_link）。', 'Shinonomeiro_C' ),
			'img_upload_api' => esc_html__( '配置评论图片上传接口的img upload api参数。', 'Shinonomeiro_C' ),
			'img_upload_max_size' => esc_html__( '配置评论图片上传接口的img upload max size参数。', 'Shinonomeiro_C' ),
			'imgur_client_id' => esc_html__( '配置评论图片上传接口的imgur client id参数。', 'Shinonomeiro_C' ),
			'imgur_upload_image_proxy' => esc_html__( '配置评论图片上传接口的imgur upload image proxy参数。', 'Shinonomeiro_C' ),
			'smms_client_id' => esc_html__( '配置评论图片上传接口的smms client id参数。', 'Shinonomeiro_C' ),
			'chevereto_api_key' => esc_html__( '配置评论图片上传接口的chevereto api key参数。', 'Shinonomeiro_C' ),
			'cheverto_url' => esc_html__( '配置评论图片上传接口的cheverto url参数。', 'Shinonomeiro_C' ),
			'lsky_api_key' => esc_html__( '配置评论图片上传接口的lsky api key参数。', 'Shinonomeiro_C' ),
			'lsky_url' => esc_html__( '配置评论图片上传接口的lsky url参数。', 'Shinonomeiro_C' ),
			'comment_image_proxy' => esc_html__( '设置评论系统的image_proxy行为。', 'Shinonomeiro_C' ),
			'mail_notify' => esc_html__( '设置评论或系统事件的邮件通知开关。', 'Shinonomeiro_C' ),
			'admin_notify' => esc_html__( '设置评论或系统事件的邮件通知开关。', 'Shinonomeiro_C' ),
			'custom_login_switch' => esc_html__( '配置登录页的switch行为。', 'Shinonomeiro_C' ),
			'login_logo_img' => esc_html__( '配置登录页的logo_img行为。', 'Shinonomeiro_C' ),
			'captcha_select' => esc_html__( '设置人机验证相关参数（captcha_select）。', 'Shinonomeiro_C' ),
			'vaptcha_vid' => esc_html__( '设置人机验证相关参数（vaptcha_vid）。', 'Shinonomeiro_C' ),
			'vaptcha_key' => esc_html__( '设置人机验证相关参数（vaptcha_key）。', 'Shinonomeiro_C' ),
			'vaptcha_scene' => esc_html__( '设置人机验证相关参数（vaptcha_scene）。', 'Shinonomeiro_C' ),
			'turnstile_site_key' => esc_html__( '设置人机验证相关参数（turnstile_site_key）。', 'Shinonomeiro_C' ),
			'turnstile_secret_key' => esc_html__( '设置人机验证相关参数（turnstile_secret_key）。', 'Shinonomeiro_C' ),
			'turnstile_theme' => esc_html__( '设置人机验证相关参数（turnstile_theme）。', 'Shinonomeiro_C' ),
			'login_urlskip' => esc_html__( '配置登录页的urlskip行为。', 'Shinonomeiro_C' ),
			'login_language_opt' => esc_html__( '配置登录页的language_opt行为。', 'Shinonomeiro_C' ),
			'admin_background' => esc_html__( '配置后台界面的background样式。', 'Shinonomeiro_C' ),
			'admin_left_style' => esc_html__( '配置后台界面的left_style样式。', 'Shinonomeiro_C' ),
			'admin_first_class_color' => esc_html__( '配置后台界面的first_class_color样式。', 'Shinonomeiro_C' ),
			'admin_second_class_color' => esc_html__( '配置后台界面的second_class_color样式。', 'Shinonomeiro_C' ),
			'admin_emphasize_color' => esc_html__( '配置后台界面的emphasize_color样式。', 'Shinonomeiro_C' ),
			'admin_text_color' => esc_html__( '配置后台界面的text_color样式。', 'Shinonomeiro_C' ),
			'chatgpt_endpoint' => esc_html__( '配置主题内 ChatGPT 功能的endpoint参数。', 'Shinonomeiro_C' ),
			'chatgpt_access_token' => esc_html__( '配置主题内 ChatGPT 功能的access_token参数。', 'Shinonomeiro_C' ),
			'chatgpt_max_tokens' => esc_html__( '配置主题内 ChatGPT 功能的max_tokens参数。', 'Shinonomeiro_C' ),
			'chatgpt_model' => esc_html__( '配置主题内 ChatGPT 功能的model参数。', 'Shinonomeiro_C' ),
			'chatgpt_api_request_timeout' => esc_html__( '配置主题内 ChatGPT 功能的api_request_timeout参数。', 'Shinonomeiro_C' ),
			'chatgpt_auto_article_summarize' => esc_html__( '配置主题内 ChatGPT 功能的auto_article_summarize参数。', 'Shinonomeiro_C' ),
			'chatgpt_exclude_ids' => esc_html__( '配置主题内 ChatGPT 功能的exclude_ids参数。', 'Shinonomeiro_C' ),
			'chatgpt_init_prompt' => esc_html__( '配置主题内 ChatGPT 功能的init_prompt参数。', 'Shinonomeiro_C' ),
			'chatgpt_annotations_prompt' => esc_html__( '配置主题内 ChatGPT 功能的annotations_prompt参数。', 'Shinonomeiro_C' ),
			...
			'iro_captcha_level' => esc_html__( '设置人机验证相关参数（iro_captcha_level）。', 'Shinonomeiro_C' ),
			'site_custom_style' => esc_html__( '设置站点级别的custom_style自定义内容。', 'Shinonomeiro_C' ),
			'site_header_insert' => esc_html__( '设置站点级别的header_insert自定义内容。', 'Shinonomeiro_C' ),
			'time_zone_fix' => esc_html__( '设置time zone fix相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'gravatar_proxy' => esc_html__( '设置gravatar proxy相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'custom_proxy_address_of_gravatar' => esc_html__( '设置custom proxy address of gravatar相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'ghcard_proxy' => esc_html__( '设置ghcard proxy相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'lightbox' => esc_html__( '设置lightbox相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'lightgallery_option' => esc_html__( '设置lightgallery option相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'code_highlight_method' => esc_html__( '设置code highlight method相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'code_highlight_prism_line_number_all' => esc_html__( '设置code highlight prism line number all相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'code_highlight_prism_autoload_path' => esc_html__( '设置code highlight prism autoload path相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'code_highlight_prism_theme_light' => esc_html__( '设置code highlight prism theme light相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'code_highlight_prism_theme_dark' => esc_html__( '设置code highlight prism theme dark相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'enable_theme_mathjax' => esc_html__( '设置enable theme mathjax相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'image_cdn' => esc_html__( '设置image cdn相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'classify_display' => esc_html__( '设置classify display相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'image_category' => esc_html__( '设置image category相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'cookie_version' => esc_html__( '设置cookie version相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'hide_login_portal' => esc_html__( '设置hide login portal相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'fontawesome_source' => esc_html__( '设置fontawesome source相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'dev_mode' => esc_html__( '设置dev mode相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'php_notice_filter' => esc_html__( '设置php notice filter相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'iro_update_source' => esc_html__( '设置iro update source相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'channel_validate_value' => esc_html__( '设置channel validate value相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'iro_update_channel' => esc_html__( '设置iro update channel相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'core_library_basepath' => esc_html__( '设置core library basepath相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'shared_library_basepath' => esc_html__( '设置shared library basepath相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'lib_cdn_path' => esc_html__( '设置lib cdn path相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'external_vendor_lib' => esc_html__( '设置external vendor lib相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'vision_resource_basepath' => esc_html__( '设置vision resource basepath相关行为与资源加载方式。', 'Shinonomeiro_C' ),
			'send_theme_version' => esc_html__( '设置send theme version相关行为与资源加载方式。', 'Shinonomeiro_C' ),
		];
